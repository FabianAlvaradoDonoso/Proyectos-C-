<?php
    ...
    function ModificarProducto($Codigo, $Categoria, $Proveedor, $Nombre, $Precio_Venta, $Precio_Neto)
    {
        ...
        //$sql_total = "UPDATE `TABLE 1` SET `COL 3`='".$Categoria."',`COL 4`='".$Proveedor."',`COL 5`='".$Nombre."',`COL 6`='".$Precio_Venta."',`COL 7`='".$Precio_Neto."' WHERE `COL 2` = '".$Codigo."'";   
    ...
    function ConsultarProducto($codigo2)
    {
        ...
        $sql_total2="SELECT * FROM `TABLE 1` WHERE `COL 2`='". $codigo2 ."'";
